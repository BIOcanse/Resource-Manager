...
for (const path of ["obj/project.assets.json", "../../src/UI/Core/obj/project.assets.json", "../../src/Shared/obj/project.assets.json", "Launcher/obj/project.assets.json", "../Resource Manager-APP.Tests/obj/project.assets.json",
