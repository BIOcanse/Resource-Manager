...
const managementWorkspace = readSource("pages/ManagementWorkspace.tsx");
...
const appearanceSettings = readSource("components/settings/AppearanceSettingsSection.tsx");
const systemIntegrationSettings = readSource("components/settings/SystemIntegrationSettingsSection.tsx");
...
const resourcePaintPlane = readSource("resourceBreakdown/ResourceSegmentPaintPlane.tsx");
...
const deviceObservation = readSource("deviceTopology/deviceTopologyObservation.ts");
const deviceView = readSource("components/DeviceTopologyView.tsx");
