...
for (const path of ["../../obj/project.assets.json", "../../NativeUi/obj/project.assets.json", "../../Shared/obj/project.assets.json", "../../Launcher/obj/project.assets.json", "../../../Resource Manager-APP.Tests/obj/project.assets.json",
